    ...
    try {
        for (let order of orders) {
            ...
            costs_list.push({
                ...
                normal: {
                    percent: `26.00%`,
                    total_price: parseFloat(((((26.00*sumCost)/100)+sumCost)/order).toFixed(2))*order,
                    unit_price:  parseFloat(((((26.00*sumCost)/100)+sumCost)/order).toFixed(2))
                },
                special: {
                    percent: `24.00%`,
                    total_price: parseFloat(((((24.00*sumCost)/100)+sumCost)/order).toFixed(2))*order,
                    unit_price:  parseFloat(((((24.00*sumCost)/100)+sumCost)/order).toFixed(2))
                },
                insite: {
                    percent: `17.00%`,
                    total_price: parseFloat(((((17.00*sumCost)/100)+sumCost)/order).toFixed(2))*order,
...
const calHotStampCost = async (order, hotStampData) => {
    ...
    try {
        ...
        const cal_hotStamp = {
            ...
            other_avr: 0.1,
            stamp_color_cost: (parseFloat(stamp_color_cost.toFixed(2)) < 0.30) ? 0.30 : parseFloat(stamp_color_cost.toFixed(2)),
            ...
            details: {
                ...
                'ค่าปั้มเคต่อชิ้น' : (parseFloat(stamp_color_cost.toFixed(2)) < 0.30) ? 0.30 : parseFloat(stamp_color_cost.toFixed(2)),
            },
            cal: {
